...
const run = preload("res://sprites/player-two_run-Sheet.png")
const idle = preload("res://sprites/player-two_ldle.png")
const jump = preload("res://sprites/player-two_jump-Sheet.png")
const atack = preload("res://sprites/player-two_attack-Sheet.png")
